...
/* remove transportadoras duplicadas */
...
filtrado.sort((a,b)=> Number(a.price) - Number(b.price));
...
<header style={{background:"#000",textAlign:"center",padding:"40px"}}>
...
<button
onClick={()=>registrarPedido(product)}
style={{
display:"block",
background:"#000",
color:"#fff",
